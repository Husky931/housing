...
export default function ApartmentClicked({ route }) {
    ...
    const apartmentData = useContext(ApartmentData).filter((f) => f.id === apartmentID)[0]
    ...
    useEffect(() => {
        console.log(sentApartmentImages.image)
    })
    ...
    return (
        <View style={styles.mainContainer}>
          ...
          <Image style={styles.imageDisplay} source={apartmentData.image} />
                ...
                <View>{/* <Carousel style="slide" items={sentApartmentImages} /> */}</View>
                ...
                <View style={styles.box_three_description}>
                    <Text style={[globalStyles.fontWeight800, globalStyles.m_t_b_5, globalStyles.fontSize2]}>
                        Краток опис
                    </Text>
                    <Text>
