...
export default function LoginRegistedModal({ createdUserRerenden }) {
    const { setLoggedIn } = useContext(GlobalData)
        ...
        <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"}>
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                <View style={styles.container}>
                    <Image style={styles.imagePreview} source={require("../images/front-image.jpg")} />
                    {!displayLoginBox && !displayRegisterBox && (
                        <View style={styles.signUpBox}>
                            <Pressable style={styles.signUpForm} onPress={() => setDisplayRegisterBox(true)}>
                                <Ionicons name="mail" size={25} color="#2eb6b6" />
                                <Text
                                    style={[globalStyles.m_l_r_6, globalStyles.fontSize2, globalStyles.fontWeight700]}
                                >
                                    Register with email
                                </Text>
                            </Pressable>
                            <Pressable style={styles.logInForm} onPress={() => setDisplayLoginBox(true)}>
                    ...
                    {displayLoginBox && (
                        <View style={styles.signUpBox}>
                            ...
                            <Pressable style={styles.submitBtn} onPress={() => logInUserLoginBox()}>
                                <Text style={[globalStyles.white, globalStyles.fontWeight700, globalStyles.fontSize2]}>
                                    Submit
                                </Text>
                            </Pressable>
                        </View>
                    ...
                    {displayRegisterBox && (
                        <View style={styles.signUpBox}>
                            ...
                            <Pressable style={styles.submitBtn} onPress={() => registerUser()}>
                                <Text style={[globalStyles.white, globalStyles.fontWeight700, globalStyles.fontSize2]}>
                                    Submit
                                </Text>
                            </Pressable>
